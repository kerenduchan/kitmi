...
async def update_payee(session, payee_id, subcategory_id, ignore):
    logging.info(f'DB: update_payee payee_id={payee_id} '
                 f'subcategory_id={subcategory_id} ignore={ignore}')
    ...
    # only set ignore (true/false) if it was supplied
